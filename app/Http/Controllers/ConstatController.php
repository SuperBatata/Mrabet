...
class ConstatController extends Controller
{
    ...
    public function showContainerConstat($id_container)
    {
        $remorque=Remorque::where('id_container',$id_container)->first();
        $dommages_phase_1= Dommage::where('id_container',$remorque['id_container'])->where('etat','phase1')->get();
        $dommages_phase_2= Dommage::where('id_container',$remorque['id_container'])->where('etat','phase2')->get();
