...
<div class="container-fluid " style="padding: 10px">
 ...
 {{Form::model($container,['action'=>'ContainerController@updateContainer','method'=>'POST'])}}
 {!! Form::hidden('id_container') !!}
...
<div class="form-group">
    {!!Form::label('Chargeur','Chargeur')!!}

    {!!Form::select('Chargeur',$chargeurs,$container->chargeur,['class'=>'form-control'])!!}
    @error('Chargeur')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
...
{{ Form::select('Type',[
    ...
    'A'=>[
        'A0'=>'A0']
],$container->type,['class'=>'form-control']  ) }}
 @error('Type')
 <div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
...
{{Form::select('Length',[
    ...
    'L'=>'L : 45 feet',
    'M'=>'M : 48 feet',
    ],$container->length,['class'=>'form-control'])}}
     @error('Length')
     <div class="alert alert-danger">{{ $message }}</div>
    @enderror
</div>
...
{{Form::select('Height',[
    ...
    '5'=>'5 : 9 feet 6 inches "high cube "',
     ],$container->height,['class'=>'form-control'])}}
</div>
...
<div class="form-group">
    ...
    {{Form::select('Dommage_Name',[
      ...
      ],$container->DommageName,['class'=>'form-control'])}}
    </div>
    <div class="form-group">
    ...
    {{Form::select('Position',[
          'D'=>     'D',
               'G'=>'G',
         ],$container->Position,['class'=>'form-control'])}}
    </div>
    <div class="form-group">
    ...
    {{Form::select('Anciennete',[
         ...
         ],$container->Anciennete,['class'=>'form-control'])}}
    </div>
    <div class="form-group">
    ...
    'DG/DF'=>'DG/DF',
    'Autre'=>'Autre..',
         ],$container->Dommage,['class'=>'form-control'])}}
    </div>
    <div class="form-group">
   ...
   'Autre'=> 'Autre..',
        ...
        ],$container->Detail,['class'=>'form-control'])}}
    </div>
    <div class="form-group">
    ...
    {{Form::select('Unite',[
          ...
          '10000'=>'10000',
          '12000'=>'12000',
        ],$container->Unite,['class'=>'form-control'])}}
    </div>

 <div class="form-group">
 {!! Form::submit('Ajouter et passer a l\'ajout des dommages', ['class'=>'btn btn-primary form-group']) !!}
 </div>
 {{Form::close()}}
