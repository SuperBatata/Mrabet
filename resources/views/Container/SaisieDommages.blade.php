...
<body style="background-color: #dcdcdc ">
    ...
    <form id="addDommage" action="{{action('ContainerController@addDommageContainer')}}"  method="POST">
        ...
        <input name="id_container" type="hidden" value="7">
        ...
        <div class="grid-1" style=" margin:4px 20px 4px 20px;background-color: #dcdcdc ;color:black ">
            <div class="grid" style="background-color:#a8e4a0;border-radius:7px ;">
                ...
                <input type="text" style="margin: 0;width:180px;" name="indentification"
                     placeholder="enter indentification" required>
                @csrf
                ...
                @csrf
                <input type="text" name="plomb" style="margin: 0;width:180px;"                     placeholder="enter plomb " required>
                @if ($errors->has('Plomb'))
                <strong>{{ $errors->first('Plomb') }}</strong>
                @endif
                <label for="Type">Type</label>
                @csrf
                <input type="text" name="Type" style="margin: 0 6px ;width:180px;"
        ...
        <div style="padding:10px ;background-color:#f5f5f5 ;margin:0px">
            <label for="Dommage_Name" class="">Saisie Dommage</label>
            <div class="grid-5">
    ...
    <script>
        ...
        $('#send_form').click(function(e){
           ...
           $.ajax({
              url: "{{action('ContainerController@addDommageContainer')}}",
              method: 'post',
