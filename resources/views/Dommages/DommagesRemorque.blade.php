...
<div class="row">
    ...
    <a  href="{{route('saisieDommage',$id_remorque)}}" class="btn-lg btn-outline-info " ><i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
$(document).ready(function() {
    ...
    'X-CSRF-Token': '{{ csrf_token() }}',
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('listeDommagesRemorque',$id_remorque) }}',
        columns: [
