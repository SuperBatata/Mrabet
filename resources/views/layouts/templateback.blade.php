                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-puzzle-piece"></i><a class="dropdown-item" href="{{ route('addChargeur') }}">Add Chargeur</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-puzzle-piece"></i><a href="{{ route('CVoyageList') }}">liste
                                    voyages</a></li>
  <li><i class="menu-icon fa fa-puzzle-piece"></i><a href="{{ route('tachev') }}">Tache Valider</a></li>
