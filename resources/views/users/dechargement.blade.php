...
<body style="background-color: #dcdcdc ">
    <nav class="navbar navbar-inverse" style="background-color:black">
        <div class="container-fluid">
         ...
         <a href="{{action('DommageController@index',$idVoyage)}}  " class="btn btn-danger navbar-btn" >Dommage list</a>
        </div>
      </nav>
      @if (count($errors) > 0)
    ...
    @endif
<form id="addDommage" class="md-form"  action="{{action('DommageController@store',$idVoyage)}}" method="POST"  enctype="multipart/form-data">
    ...
    <input name="_token" type="hidden" value="pV1vWWdUqFDfYsBjKag43C3NvzbIC0lHtMnv9BpI">
        ...
        <div class="grid" style="background-color:#a8e4a0;border-radius:7px ;">
            ...
            <input type="text" style="margin: 0;width:180px; " name="indentification"  placeholder="enter indentification">
            @csrf
            <label for="plomb">plomb</label>
            @csrf
            <input type="text" name="plomb" style="margin: 0;width:180px;" placeholder="enter plomb ">

            <label for="Type">Type</label>
            @csrf
            <input type="text" name="Type" style="margin: 0 6px ;width:180px;" placeholder="enter Type ">
        </div>
    </div>
    ...
    <script>
        ...
        $('#send_form').click(function(e){
           ...
           $.ajax({
              url: "{{action('DommageController@store',$idVoyage)}}",
              method: 'post',
