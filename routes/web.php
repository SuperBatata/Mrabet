...
Route::post('chargement/{idVoyage}', 'DommageController@store');
...
Route::get('listDommages/{idVoyage}','DommageController@index')->name('DList');
...
Route::get('cDommagephase1/{idVoyage}','remorqueController@cDommagephase1')->name('cDommagephase1');
Route::get('cDommagephase2/{idVoyage}','remorqueController@cDommagephase2')->name('cDommagephase2');
//<Route:get></Route:get>
